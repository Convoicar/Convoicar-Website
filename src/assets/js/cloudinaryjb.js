...
(function () {
    ...
    var audi = cl
        .imageTag("convoicar_website/audi_s5wkiy", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
        ...
        .toHtml();
    var firststop = cl
        .imageTag("convoicar_website/firststop_uku9rt", {
            effect: "colorize",
            color: "#fdc944",
            height: 40,
            quality: 100,
        ...
        .toHtml();
    var topgarage = cl
        .imageTag("convoicar_website/topgarage_j5vofs", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
        ...
        .toHtml();
    var lexus = cl
        .imageTag("convoicar_website/lexus_pcqxzs", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
        ...
        .toHtml();
    var mini = cl
        .imageTag("convoicar_website/mini", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
        ...
        .toHtml();
    var vwvu = cl
        .imageTag("convoicar_website/vwvu_c875ni", {
            effect: "colorize",
            color: "#fdc944",
            height: 70,
            quality: 100,
        ...
        .toHtml();
    var vw = cl
        .imageTag("convoicar_website/vw_bt0oor", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
        ...
        .toHtml();
    var toyota = cl
        .imageTag("convoicar_website/toyota", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
        ...
        .toHtml();
    var seat = cl
        .imageTag("convoicar_website/seat_uoveak", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
        ...
        .toHtml();
    var fiat = cl
        .imageTag("convoicar_website/fiat1234", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
        ...
        .toHtml();
    var jeep = cl
        .imageTag("convoicar_website/jeep_s8qpih", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
        ...
        .toHtml();
    var alfaromeo = cl
        .imageTag("convoicar_website/alfaromeo", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
        ...
        .toHtml();
    var bmw = cl
        .imageTag("convoicar_website/bmw2", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
        ...
        .toHtml();
    //var speedy = cl.imageTag('convoicar_website/speedy', {effect: "colorize", color: "#fdc944", height: 50, quality: 100, crop: "scale", format: "png"}).toHtml();
    var maserati = cl
        .imageTag("convoicar_website/maserati", {
            effect: "colorize",
            color: "#fdc944",
            height: 50,
            quality: 100,
    ...
    if (document.getElementById("img-band15") !== null) {
        document.getElementById("img-band15").innerHTML = speedy;
    }
